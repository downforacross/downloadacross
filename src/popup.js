...
var loaders = {
  ...
  "Guardian Cryptic": GuardianCrypticLoader,
};
...
function selectSource(source) {
  ...
  sources.forEach(function (sourceEl) {
    if (sourceEl.textContent === source) {
      document
        .querySelectorAll(".source-select--item.selected")
        .forEach(function (el) {
